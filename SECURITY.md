...
You can expect an initial acknowledgement in a reasonable time. After the
maintainer confirms the issue and releases a fix, the maintainer publishes the
advisory with credit to the reporter, unless you ask for no credit.
